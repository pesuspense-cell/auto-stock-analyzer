...
const SECTOR_ETFS: readonly [string, string, "US" | "KR", string][] = [
  ...
  ["396500.KS", "TIGER Fn반도체TOP10", "KR", "💻 반도체"],
  ["464930.KS", "SOL AI반도체소부장", "KR", "💻 반도체소부장"],
  ["464520.KS", "KoAct 바이오헬스케어", "KR", "🧬 바이오"],
  ["305710.KS", "KODEX 2차전지산업", "KR", "🔋 2차전지"],
  ["091180.KS", "KODEX 자동차", "KR", "🚗 자동차"],
  ["466920.KS", "SOL 조선TOP3플러스", "KR", "🚢 조선"],
  ["449450.KS", "PLUS K방산", "KR", "🛡 방산"],
  ["484310.KS", "KODEX AI전력핵심설비", "KR", "⚡ 전력"],
  ["438100.KS", "TIGER 코리아원자력", "KR", "⚛ 원전"],
  ["440790.KS", "KODEX 로봇액티브", "KR", "🤖 로봇"],
  ["414270.KS", "PLUS 우주항공&UAM", "KR", "🚀 우주"],
  ["408220.KS", "PLUS 태양광&ESS", "KR", "☀ 태양광"],
  ["385530.KS", "KODEX 신재생에너지", "KR", "🌱 재생에너지"],
  ["228790.KS", "TIGER 화장품", "KR", "💄 화장품"],
  ["475580.KS", "ACE KPOP포커스", "KR", "🎵 엔터"],
  ["300640.KS", "TIGER 지주회사", "KR", "🏢 지주사"],
  ["466940.KS", "TIGER 은행고배당TOP10", "KR", "🏦 은행"],
  ["102960.KS", "KODEX 증권", "KR", "📈 증권"],
];
