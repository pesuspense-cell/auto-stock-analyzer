...
//   · 미국 15개 + 국내 20개, 전일 종가 대비 일간 등락률(fetchQuote 의 changePct).
...
/** [티커, ETF명, 국가, 테마] — isIndex 는 "📊" 태그로 판정. */
const SECTOR_ETFS: readonly [string, string, "US" | "KR", string][] = [
  ["SPY", "S&P 500", "US", "📊 지수"],
  ["QQQ", "나스닥 100", "US", "📊 지수"],
  ["DIA", "다우존스", "US", "📊 지수"],
  ["SCHD", "배당성장", "US", "💰 배당"],
  ...
  ["BIL", "미국채 단기", "US", "📋 채권"],
  ["VNQ", "리츠", "US", "🏢 리츠"],
  ["069500.KS", "KODEX 200", "KR", "📊 코스피"],
  ["229200.KQ", "KODEX 코스닥150", "KR", "📊 코스닥"],
  ["396500.KS", "TIGER 반도체TOP10", "KR", "💻 반도체"],
  ["455850.KS", "SOL AI반도체소부장", "KR", "💻 반도체소부장"],
  ["462900.KS", "KoAct 바이오헬스케어액티브", "KR", "🧬 바이오"],
  ["305720.KS", "KODEX 2차전지산업", "KR", "🔋 2차전지"],
  ["091180.KS", "KODEX 자동차", "KR", "🚗 자동차"],
  ["466920.KS", "SOL 조선TOP3플러스", "KR", "🚢 조선"],
  ["449450.KS", "PLUS K방산", "KR", "🛡 방산"],
  ["487240.KS", "KODEX AI전력핵심설비", "KR", "⚡ 전력"],
  ["0091P0.KS", "TIGER 코리아원자력", "KR", "⚛ 원전"],
  ["445290.KS", "KODEX 로봇액티브", "KR", "🤖 로봇"],
  ["421320.KS", "PLUS 우주항공&UAM", "KR", "🚀 우주"],
  ["457990.KS", "PLUS 태양광&ESS", "KR", "☀ 태양광"],
  ["385510.KS", "KODEX 신재생에너지액티브", "KR", "🌱 재생에너지"],
  ["228790.KS", "TIGER 화장품", "KR", "💄 화장품"],
  ["475050.KS", "ACE KPOP포커스", "KR", "🎵 엔터"],
  ["307520.KS", "TIGER 지주회사", "KR", "🏢 지주사"],
  ["466940.KS", "TIGER 은행고배당플러스TOP10", "KR", "🏦 은행"],
  ["102970.KS", "KODEX 증권", "KR", "📈 증권"],
];
...
export async function getSectorEtfs(): Promise<EtfsResponse> {
  ...
  const results = await Promise.all(
    SECTOR_ETFS.map(async ([ticker, name, country, tag]) => {
